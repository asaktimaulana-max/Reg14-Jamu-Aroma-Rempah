...
<input type="text" name="nama_bahan" value="<?= $bahan['nama_bahan'] ?>" class="form-control" required>
</div>

<div class="mb-3">
<label>Khasiat</label>
<textarea name="khasiat" class="form-control" rows="3"><?= $bahan['khasiat'] ?></textarea>
</div>
