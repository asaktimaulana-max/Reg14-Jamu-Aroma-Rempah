...
<div class="d-flex">
    ...
    <div class="sidebar">
        <div class="logo-container">
            ...
            <span class="badge bg-success small">Administrator</span>
        </div>
        ...
        <ul class="nav flex-column mt-3">
            ...
            <li class="nav-item">
                <a href="<?= base_url('admin/franchise') ?>" class="nav-link <?= (strpos(current_url(), 'franchise') !== false) ? 'active' : '' ?>">
                    <i class="bi bi-shop"></i> Franchise
                </a>
            </li>
            <li class="nav-item">
                <a href="<?= base_url('admin/produk') ?>" class="nav-link <?= (strpos(current_url(), 'produk') !== false) ? 'active' : '' ?>">
                    <i class="bi bi-cup-hot-fill"></i> Produk Jamu
                </a>
            </li>
            <li class="nav-item">
                <a href="<?= base_url('admin/bahan') ?>" class="nav-link <?= (strpos(current_url(), 'bahan') !== false) ? 'active' : '' ?>">
                    <i class="bi bi-box-seam-fill"></i> Bahan Baku
                </a>
            </li>
            <li class="nav-item">
                <a href="<?= base_url('admin/pemesanan') ?>" class="nav-link <?= (strpos(current_url(), 'pemesanan') !== false) ? 'active' : '' ?>">
                    <i class="bi bi-cart-fill"></i> Pemesanan
                </a>
            </li>
            <li class="nav-item">
                <a href="<?= base_url('admin/bagi_hasil') ?>" class="nav-link <?= (strpos(current_url(), 'bagi_hasil') !== false) ? 'active' : '' ?>">
                    <i class="bi bi-pie-chart-fill"></i> Rekap Bagi Hasil
                </a>
            </li>
            <li class="nav-item">
                <a href="<?= base_url('admin/user') ?>" class="nav-link <?= (strpos(current_url(), 'user') !== false) ? 'active' : '' ?>">
                    <i class="bi bi-people-fill"></i> Manajemen User Mitra
                </a>
            </li>
            <li class="nav-item">
        ...
        <div class="mt-auto p-4">
            <a href="<?= base_url('logout') ?>" class="nav-link text-danger border border-danger-subtle rounded-3">
